        ...
        <div className="relative h-48">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-end p-6">
            <div className="relative">
              <img
                src="https://images.unsplash.com/photo-1502685104224-e9e77b3e7c62?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyMzAyMTB8MHwxfGFsbHwxfHx8fHx8fHwxNjg1NzE0NzE2&ixlib=rb-1.2.1&q=80&w=400"
                alt="Profile"
